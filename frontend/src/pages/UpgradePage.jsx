  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <p className="text-slate-500 dark:text-slate-400 text-sm mt-1 mb-4">
        {isPro ? 'All premium features are unlocked.' : <>Unlock <span className="font-logo font-extrabold tracking-tight uppercase">Strelo<span className="text-rose-500">IQ</span></span> and let the engine write your training week.</>}
      </p>
      ...
      {isPro ? (
        <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 bg-white dark:bg-slate-900">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">You have access to all features including <span className="font-logo font-extrabold tracking-tight uppercase">Strelo<span className="text-rose-500">IQ</span></span>.</p>
        </div>
      ) : (

  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4">
      ...
      <div className="flex gap-2 overflow-x-auto">
        {/* Today */}
        {todayWeather && (
          <div className="flex-1 min-w-[5rem] bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800/50 rounded-lg px-3 py-2.5 text-center">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-indigo-500 dark:text-indigo-400 mb-1">Today</p>
            <WeatherIcon code={todayWeather.code} size={20} className="mx-auto text-indigo-500 dark:text-indigo-400 mb-1" />
